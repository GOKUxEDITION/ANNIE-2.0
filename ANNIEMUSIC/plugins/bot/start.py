...
"""
        ...
        try:
            ...
            vip = await message.reply_text(f"** ꨄ︎❣️.....**")
            await vip.edit_text(f"** ꨄ︎.❣️....**")
            await vip.edit_text(f"**  ꨄ︎..❣️...**")
            await vip.edit_text(f"** ꨄ︎...❣️..**")
            await vip.edit_text(f"** ꨄ︎....❣️.**")
            await vip.edit_text(f"** ꨄ︎.....❣️**")
            ...
            await vip.delete()
            vips = await message.reply_text("**⚡𝗔𝗻𝗻𝗶𝗲 𝟮.𝟬**")
            await asyncio.sleep(0.1)
            await vips.edit_text("**⚡𝗡𝗲𝘄 𝟮.𝟬**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡𝗜𝗻𝘀𝘁𝗮𝗹𝗹𝗮𝘁𝗶𝗼𝗻**")
            #  await asyncio.sleep(0.1)
            await vips.edit_text("**⚡𝗢𝗽𝗲𝗿𝗮𝘁𝗶𝗼𝗻**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡𝗦𝗲𝗿𝘃𝗲𝗿**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡𝗢𝗻**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡𝗠𝘂𝘀𝗶𝗰**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡𝗦𝗲𝗰𝘂𝗿𝗶𝘁𝘆**")
            await asyncio.sleep(0.1)
            await vips.edit_text("**⚡𝗠𝗮𝗻𝗲𝗻𝗴𝗺𝗲𝗻𝘁....**")
            await asyncio.sleep(0.1)
            await vips.edit_text("**⚡KAIxRObot**")
            await asyncio.sleep(0.1)
